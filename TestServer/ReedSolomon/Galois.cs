namespace TestServer.ReedSolomon
{
    ...
    public sealed class Galois
    {
        ...
        static short[] LOG_TABLE = new short[] {
        ...
        static sbyte[] EXP_TABLE = new sbyte[] {
        ...
        public static byte Multiply(byte a, byte b)
        {
            ...
            else
            {
                ...
                return (byte)EXP_TABLE[logResult];
            }
        }
        ...
        public static short[] GenerateLogTable(int polynomial)
        {
            ...
            for (int log = 0; log < FIELD_SIZE - 1; log++)
            {
                if (result[b] != -1)
                {
                    throw new InvalidOperationException("BUG: duplicate logarithm (bad polynomial?)");
                }
                result[b] = (short)log;
                b = b << 1;
                if (FIELD_SIZE <= b)
